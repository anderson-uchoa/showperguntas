...
<head runat="server">
    <title>Show de Perguntas - Gerenciador de jogadores</title>
...
<h1 style="text-align:center">Gerenciador de jogadores</h1>
    <form id="form1" runat="server">
     <div class="borda" align="center" style="width: 250px;">
        <asp:Table ID="Gerenciar_Jogadores" runat="server" Width="250px" 
        BackColor="#F8F8F8" BorderColor="#F8F8F8" 
            ...
            <asp:TableCell HorizontalAlign="Center">
                ...
                <asp:ImageButton ID="Listar" runat="server" onclick="ListarJogadores_Click" ImageUrl="/Imagens/listar_jogador.png" Width="64" Height="64" AlternateText="Listar jogadores" />
