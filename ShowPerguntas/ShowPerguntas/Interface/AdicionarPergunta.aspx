                ...
                <asp:Table ID="Table" runat="server" Width="1114px">
                    <asp:TableRow ID="Enunciado">
                        ...
                        <asp:TableCell ID="Collum1">
                            <asp:TextBox ID="EnunciadoTextBox" Width="800" runat="server"></asp:TextBox>
                    ...
                    <asp:TableRow ID="AlternativaCorreta">
                        ...
                        <asp:TableCell ID="TableCell3">
                            <asp:TextBox ID="AlternativaCorretaTextBox" Width="800" runat="server"></asp:TextBox>
                    ...
                    <asp:TableRow ID="AlternativaIncorreta1">
                        ...
                        <asp:TableCell ID="TableCell4">
                            <asp:TextBox ID="AlternativaIncorreta1TextBox" Width="800" runat="server"></asp:TextBox>
                    ...
                    <asp:TableRow ID="AlternativaIncorreta2">
                        ...
                        <asp:TableCell ID="TableCell5">
                            <asp:TextBox ID="AlternativaIncorreta2TextBox" Width="800" runat="server"></asp:TextBox>
                    ...
                    <asp:TableRow ID="AlternativaIncorreta3">
                        ...
                        <asp:TableCell ID="TableCell6">
                            <asp:TextBox ID="AlternativaIncorreta3TextBox" Width="800" runat="server"></asp:TextBox>
                    ...
                    <asp:TableRow ID="AlternativaIncorreta4">
                        ...
                        <asp:TableCell ID="TableCell7">
                            <asp:TextBox ID="AlternativaIncorreta4TextBox" Width="800" runat="server"></asp:TextBox>
